...
nodes =  read.csv(file = 'topic 0 nodes.csv', na.strings=c("","NA"))
per_stem = read.csv(file = 'edges word stem topic0 1.csv', na.strings=c("","NA"))
...
V(network)$size <- edges$weight*0.5
